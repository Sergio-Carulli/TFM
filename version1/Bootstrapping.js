...
var writer;
var ontology;
var prefixes = {owl:'http://www.w3.org/2002/07/owl#', 
...
function uploadOntology(localPath, url, username, email){
    if(url == undefined || url == null){
        ...
        exec(`cd ${localPath} && git init -b master && git add . && git commit -m "Initial Commit" && git remote add origin ${url} && git push origin master`, (error, stdout, stderr) => {
            if (error) {
                console.log(`error: ${error.message}`);
                return;
            }
